...
-- ALTER TABLE `product`
-- CHANGE COLUMN `image_url` `image` VARCHAR(255) DEFAULT NULL;
...
INSERT INTO `reseller` (`reseller_id`, `name`, `email`, `phone_number`, `active_status`, `join_date`, `address`, `reseller_photo`) VALUES
(1, 'mary cruz', 'mary@gmail.com', 2147483647, 1, '2024-05-30', 1, NULL),
(2, 'anna', 'anna@gmail.com', 2147483647, 1, '2024-05-30', 2, NULL);
