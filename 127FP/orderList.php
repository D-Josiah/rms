...
<body>
    ...
    <div class="search-filter-container">
        ...
        <a href="http://localhost/127FP/pages/addOrder.php"><button class="add-button">Add</button></a>
    </div>
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<div class='order-item'>
                            ...
                            <div class='order-info-right'>
                                ...
                                <a href='orderDetails.php?order_id={$row['order_id']}' class='view-details-link'>View Details</a>
                            </div>
                        </div>";
                }
            } else {
